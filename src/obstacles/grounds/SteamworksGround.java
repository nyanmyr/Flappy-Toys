...
public class SteamworksGround extends Ground {

    public SteamworksGround(int offsetX){
        super(offsetX);
        LoadSprite();
    }
    ...
    public final void LoadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/grounds/steamworks_ground.png");
            if (resource != null) {
                ...
                throw new RuntimeException("Image resource not found: /steamworks_ground.png");
            }
        } catch (IOException e) {
