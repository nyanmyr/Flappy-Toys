...
public class DesertGround extends Ground {

    public DesertGround(int offsetX){
        super(offsetX);
        LoadSprite();
    }
    ...
    public final void LoadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/grounds/desert_ground.png");
            if (resource != null) {
                ...
                throw new RuntimeException("Image resource not found: /desert_ground.png");
            }
        } catch (IOException e) {
