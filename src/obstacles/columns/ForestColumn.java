...
public class ForestColumn extends Column {

    public ForestColumn(int gap, int offset, int lifeTime) {
        super(lifeTime);
    ...
    public final void LoadSprite(int gap, int offset) {
        try {
            java.net.URL topSprite = getClass().getResource("/resources/columns/forest_column.png");
            java.net.URL bottomSprite = getClass().getResource("/resources/columns/forest_column.png");
            if (topSprite != null && bottomSprite != null) {
                ...
                throw new RuntimeException("Image resource not found: forest_column.png");
            }
        } catch (IOException e) {
