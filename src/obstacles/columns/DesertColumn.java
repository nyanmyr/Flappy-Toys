...
public class DesertColumn extends Column {

    public DesertColumn(int gap, int offset, int lifeTime) {
        super(lifeTime);
    ...
    public final void LoadSprite(int gap, int offset) {
        try {
            java.net.URL topSprite = getClass().getResource("/resources/columns/desert_column.png");
            java.net.URL bottomSprite = getClass().getResource("/resources/columns/desert_column.png");
            if (topSprite != null && bottomSprite != null) {
                ...
                throw new RuntimeException("Image resource not found: desert_column.png");
            }
        } catch (IOException e) {
