...
public class ScarabToken extends Collectible {

    public ScarabToken(int lifeTime) {
        super(lifeTime);
        loadSprite();
    }
    ...
    public final void loadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/animations/collectibles/scarab_token_anim.png");
            if (resource == null) {
                throw new RuntimeException("Image resource not found: /scarab_token_anim.png");
            }
