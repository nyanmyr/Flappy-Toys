...
public class GearToken extends Collectible {

    public GearToken(int lifeTime) {
        super(lifeTime);
        loadSprite();
    }
    ...
    public final void loadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/animations/collectibles/gear_token_anim.png");
            if (resource == null) {
                throw new RuntimeException("Image resource not found: /gear_token_anim.png");
            }
