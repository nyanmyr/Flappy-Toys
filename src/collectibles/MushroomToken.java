...
public class MushroomToken extends Collectible {

    public MushroomToken(int lifeTime) {
        super(lifeTime);
        loadSprite();
    }
    ...
    public final void loadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/animations/collectibles/mushroom_token_anim.png");
            if (resource == null) {
                throw new RuntimeException("Image resource not found: /mushroom_token_anim.png");
            }
