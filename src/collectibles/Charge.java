...
public class Charge extends Collectible {

    public Charge(int lifeTime) {
        super(lifeTime);
        loadSprite();
    }
    ...
    public CollectibleType giveReward() {
        return CollectibleType.CHARGE;
    }

    @Override
    public final void loadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/animations/collectibles/charge_anim.png");
            if (resource == null) {
                throw new RuntimeException("Image resource not found: /teddycopter_anim.png");
            }
