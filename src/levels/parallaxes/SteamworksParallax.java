...
public class SteamworksParallax extends Parallax {

    public SteamworksParallax(int offsetX, ParallaxLevel level){
        super(offsetX, level);
        LoadSprite();
    }
    ...
    public final void LoadSprite() {
        try {
            ...
            switch (level) {
                case LEVEL_1 -> {
                    resource = getClass().getResource("/resources/parallaxes/steamworks_parallax1.png");
                }
                case LEVEL_2 -> {
                    resource = getClass().getResource("/resources/parallaxes/steamworks_parallax2.png");
                    offsetY = 100;
                }
                default ->
