...
public class Foldy extends Toy {
    ...
    public final void LoadSprite() {
        try {
            java.net.URL resource = getClass().getResource("/resources/animations/foldy_anim.png");
            if (resource == null) {
                throw new RuntimeException("Image resource not found: /resources/animations/foldy_anim.png");
            }
